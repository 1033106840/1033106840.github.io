function sohu_pvinsight_engine(){
    ...
    */
    ...
    if(document.domain.indexOf("https://js.sohu.com/.focus.cn") >= 0 || document.domain.indexOf("https://js.sohu.com/home.sohu.com") >= 0 || document.domain.indexOf("https://js.sohu.com/ihome.sohu.com") >= 0) {
        var spv_dhead = document.getElementsByTagName("head")[0],
	        spv_dbody = document.body,
	        d = spv_dhead || spv_dbody,
            suv_server = "//pv.focus.cn/suv",
            spv_server = "https://pv.focus.cn/";
    }else{
        var spv_dhead = document.getElementsByTagName("head")[0],
	        spv_dbody = document.body,
	        d = spv_dhead || spv_dbody,
            suv_server = "//pv.sohu.com/suv",
            spv_server = "https://pv.sohu.com/";
    }
    
    if (spv_channel_flag || top.location == self.location || document.domain.indexOf("https://js.sohu.com/.go2map.com") >= 0) {
        var newsuv;
        var spv_server_src;
